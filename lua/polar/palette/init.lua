...
M.codeblock = shade.darken(M.nord0, 0.05)
...
M.diff = {
  add    = shade.blend(M.green, M.nord0, 0.25),
  delete = shade.blend(M.red, M.nord0, 0.25),
  change = shade.blend(M.yellow, M.nord0, 0.25),
  text   = shade.blend(M.yellow, M.nord0, 0.35),
}
