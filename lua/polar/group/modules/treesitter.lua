...
function M.get(spec, config, opts)
  ...
  if not vim.treesitter.highlighter.hl_map then -- https://github.com/nvim-treesitter/nvim-treesitter/pull/3365
    ...
    return {
      ...
      ["@constant.builtin"]    = { fg = palette.magenta, style = style.constants }, -- Built-in constant values: `nil` in Lua.
      ["@constant.macro"]      = { fg = palette.magenta, style = style.constants }, -- Constants defined by macros: `NULL` in C.

      ["@constructor"]           = { fg = palette.blue }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
      ...
      ["@field"]                 = { fg = palette.white }, -- Object and struct fields.
      ["@float"]                 = { link = "Constant" }, -- Floating-point number literals.
      -- ["@function"]            = {}, -- Function calls and definitions.
      ["@function.builtin"]      = { fg = palette.blue, style = style.functions }, -- Built-in functions: `print` in Lua.
      ["@function.macro"]        = { fg = palette.blue, style = style.functions }, -- Macro defined functions (calls and definitions): each `macro_rules` in Rust.
      ...
      ["@keyword.function"]      = { fg = palette.blue, style = style.functions }, -- Keywords used to define a function: `function` in Lua, `def` and `lambda` in Python.
      ["@keyword.operator"]      = { fg = palette.blue, style = "bold" }, -- Unary and binary operators that are English words: `and`, `or` in Python; `sizeof` in C.
      -- ["@keyword.return"]      = {}, -- Keywords like `return` and `yield`.
      ["@label"]                 = { fg = palette.blue }, -- GOTO labels: `label:` in C, and `::label::` in Lua.
      -- ["@method"]              = {}, -- Method calls and definitions.
      ["@namespace"]             = { fg = palette.magenta }, -- Identifiers referring to modules and namespaces.
      ...
      ["@operator"]              = { fg = palette.blue, style = style.operators }, -- Binary or unary operators: `+`, and also `->` and `*` in C.
      -- ["@parameter"]           = {}, -- Parameters of a function.
      -- ["@parameter.reference"] = {}, -- References to parameters of a function.
      ["@property"]              = { link = "@field" }, -- Same as `@field`.

      ["@punctuation.delimiter"] = { fg = palette.white }, -- Punctuation delimiters: Periods, commas, semicolons, etc.
      ["@punctuation.bracket"]   = { fg = palette.white }, -- Brackets, braces, parentheses, etc.
      ["@punctuation.special"]   = { fg = palette.white }, -- Special punctuation that doesn't fit into the previous categories.

      -- ["@repeat"]              = {}, -- Keywords related to loops: `for`, `while`, etc.
      ["@string"]                = { link = "String" }, -- String literals.
      ["@string.regex"]          = { fg = palette.yellow, style = style.strings }, -- Regular expression literals.
      ["@string.escape"]         = { fg = palette.yellow, style = "bold" }, -- Escape characters within a string: `\n`, `\t`, etc.
      ...
      ["@text.reference"]        = { fg = palette.blue }, -- Footnotes, text references, citations, etc.
      ...
      ["@text.uri"]              = { fg = palette.white, style = "bold" }, -- URIs like hyperlinks or email addresses.
      ...
      ["@type.builtin"]          = { fg = palette.magenta, style = style.types }, -- Built-in types: `i32` in Rust.
      ["@variable"]              = { fg = palette.white, style = style.variables }, -- Variable names that don't fit into other categories.
      ["@variable.builtin"]      = { fg = palette.blue, style = style.variables }, -- Variable names defined by the language: `this` or `self` in Javascript.
      ...
      ["@tag.javascript"] = { fg = palette.blue }, -- Tags like HTML tag names.
      ["@tag.typescript"] = { fg = palette.blue }, -- Tags like HTML tag names.
    }
  else
    -- stylua: ignore
    return {
      ...
      TSConstBuiltin    = { fg = palette.magenta, style = style.constants }, -- Built-in constant values: `nil` in Lua.
      -- TSConstMacro         = {}, -- Constants defined by macros: `NULL` in C.
      TSConstructor     = { fg = palette.blue }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
      ...
      TSField           = { fg = palette.white }, -- Object and struct fields.
      -- TSFloat              = {}, -- Floating-point number literals.
      -- TSFunction           = {}, -- Function calls and definitions.
      TSFuncBuiltin     = { fg = palette.blue, style = style.functions }, -- Built-in functions: `print` in Lua.
      TSFuncMacro       = { fg = palette.blue, style = style.functions }, -- Macro defined functions (calls and definitions): each `macro_rules` in Rust.
      -- TSInclude            = {}, -- File or module inclusion keywords: `#include` in C, `use` or `extern crate` in Rust.
      -- TSKeyword            = {}, -- Keywords that don't fit into other categories.
      TSKeywordFunction = { fg = palette.blue, style = style.functions }, -- Keywords used to define a function: `function` in Lua, `def` and `lambda` in Python.
      TSKeywordOperator = { fg = palette.blue, style = "bold" }, -- Unary and binary operators that are English words: `and`, `or` in Python; `sizeof` in C.
      -- TSKeywordReturn      = {}, -- Keywords like `return` and `yield`.
      -- TSLabel              = {}, -- GOTO labels: `label:` in C, and `::label::` in Lua.
      -- TSMethod             = {}, -- Method calls and definitions.
      TSNamespace       = { fg = palette.magenta }, -- Identifiers referring to modules and namespaces.
      -- TSNone               = {}, -- No highlighting (sets all highlight arguments to `NONE`). this group is used to clear certain ranges, for example, string interpolations. Don't change the values of this highlight group.
      -- TSNumber             = {}, -- Numeric literals that don't fit into other categories.
      TSOperator        = { fg = palette.blue, style = style.operators }, -- Binary or unary operators: `+`, and also `->` and `*` in C.
      -- TSParameter          = {}, -- Parameters of a function.
      -- TSParameterReference = {}, -- References to parameters of a function.
      TSProperty        = { link = "TSField" }, -- Same as `TSField`.
      TSPunctDelimiter  = { fg = palette.white }, -- Punctuation delimiters: Periods, commas, semicolons, etc.
      TSPunctBracket    = { fg = palette.white }, -- Brackets, braces, parentheses, etc.
      TSPunctSpecial    = { fg = palette.white }, -- Special punctuation that doesn't fit into the previous categories.
      -- TSRepeat             = {}, -- Keywords related to loops: `for`, `while`, etc.
      -- TSString             = {}, -- String literals.
      TSStringRegex     = { fg = palette.yellow, style = style.strings }, -- Regular expression literals.
      TSStringEscape    = { fg = palette.yellow, style = "bold" }, -- Escape characters within a string: `\n`, `\t`, etc.
      ...
      TSURI             = { fg = palette.green, style = "bold" }, -- URIs like hyperlinks or email addresses.
      -- TSMath               = {}, -- Math environments like LaTeX's `$ ... $`
      TSTextReference   = { fg = palette.blue }, -- Footnotes, text references, citations, etc.
      ...
      TSTypeBuiltin     = { fg = palette.magenta, style = style.types }, -- Built-in types: `i32` in Rust.
      TSVariable        = { fg = palette.white, style = style.variables }, -- Variable names that don't fit into other categories.
      TSVariableBuiltin = { fg = palette.blue, style = style.variables }, -- Variable names defined by the language: `this` or `self` in Javascript.
